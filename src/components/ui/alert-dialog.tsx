  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          "bg-background/85 isolate data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-sm:max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-2xl border border-black/10 p-6 shadow-[0_24px_80px_-24px_hsl(210_15%_18%/0.4),0_8px_30px_rgb(0_0_0/0.06)] duration-200 max-w-lg backdrop-blur-2xl",
          className
        )}
        {...props}
      >
